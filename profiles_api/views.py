...
class HelloApiView(APIView):
    ...
    def get(self, request, format=None):
        '''return the list of the api view'''
        an_apiview=[
            'Uses the HTTP methods as functions(get, post, patch, put, delete)',
    ...
    def patch(self, request, pk=None):
        """Handling partial updating an object"""
...
class HelloViewSet(viewsets.ViewSet):
    ...
    def retrieve(self, request, pk=None):
        """Handling the object by its id"""
        return Response({'HTTP_METHOD': 'GET'})

    def update(self, request, pk= None):
        """Updating the object by its id"""
        return Response({'HTTP_METHOD': 'PUT'})

    def partial_update(self, request, pk=None):
        """Partially updating the Object patially"""
